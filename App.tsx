...
import { ID, TWITTER_URL, GITHUB_URL } from './constants';
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <footer className="py-32 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-12 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 items-center">
            <a href={TWITTER_URL} target="_blank" className="hover:text-blue-600 transition-colors">X</a>
            <a href={GITHUB_URL} target="_blank" className="hover:text-blue-600 transition-colors">GitHub</a>
